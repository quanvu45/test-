...
void cli_toggle_led_bulb(sl_cli_command_arg_t *arguments);
...
static const sl_cli_command_info_t cli_cmd__toggle_led_bulb = \
  SL_CLI_COMMAND(cli_toggle_led_bulb,
                 "Toggle the RGB LED on or off",
                  "",
                 {SL_CLI_ARG_END, });
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  ...
  { "toggle_led_bulb", &cli_cmd__toggle_led_bulb, false },
